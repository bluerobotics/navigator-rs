...
The capabilities of the Navigator can be accessed through the Navigator object. Please check the examples in the **[`Implementations`](struct.Navigator.html#implementations)** section.
*/
